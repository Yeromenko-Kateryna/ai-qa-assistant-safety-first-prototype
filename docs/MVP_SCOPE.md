...
4. Requirement, Risk, Test Design, Automation, and QA Review agents run sequentially.
...
- One skeleton for unambiguous UI or API input
- Automation plan without code for hybrid, ambiguous, or insufficient input
...
- Smoke and release evaluation criteria pass.
